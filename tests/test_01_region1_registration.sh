...
echo "========================================"
echo "TEST 01 - REGION 1 REGISTRACIJA"
echo "========================================"

OUTPUT_FILE="tests/test_01_output.log"

timeout 20s ./smart_meter/client_async_test sarajevo 001 domacinstvo \
    > "$OUTPUT_FILE" 2>&1
...
if grep -q "URI registracije: smartgrid://sarajevo/meter/001" "$OUTPUT_FILE"; then
